...
6. **모든 문장은 반드시 완결된 형태로 마무리할 것** — "~습니다.", "~합니다.", "~입니다." 등 종결어미 + 마침표로 자연스럽게 끝날 것. 절대 중간에 잘리거나 조사(을/를/이/가/은/는)로 끝나면 안 됨. 각 body 필드는 완전한 문장 2~4개로 구성하고, 문자 수 제한이 있어도 문장을 잘라내지 말고 짧은 완결 문장으로 다시 쓸 것.
...
**중요: 모든 텍스트 필드(body, description, subtitle 등)는 반드시 마침표(.) 또는 물음표/느낌표로 끝나는 완결 문장이어야 하며, 조사·어간·중간에서 끊긴 형태는 금지.**`;
