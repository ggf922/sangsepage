...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-ivory-light text-ink [word-break:keep-all]">
      ...
      >
        <div className="container mx-auto flex items-center justify-center gap-1.5 px-3 py-2 text-center text-[11.5px] font-medium sm:gap-2 sm:px-4 sm:text-[13px]">
          ...
          <span className="inline-flex flex-wrap items-center justify-center gap-x-1.5">
            <span className="font-serif text-[12.5px] font-extrabold tracking-tight sm:text-[14px]">
              88km
            </span>
            <span className="opacity-70">×</span>
            <span className="font-semibold tracking-tight">88 k 마트</span>
            <span className="opacity-80">— 모두모두 K-Mart 바로가기</span>
          </span>
